  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-screen flex flex-col overflow-hidden bg-background">
        ...
        {/* Decorative orange shapes (like reference) */}
        <div
        ...
        <div className="relative z-10 flex-1 max-w-6xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-center pt-28 pb-10">
          ...
          <div className="relative flex items-center justify-center min-h-[480px] lg:min-h-0">
            ...
            <img
              ...
              className="relative z-10 w-64 h-[430px] object-cover object-center rounded-3xl shadow-2xl border border-border flex-shrink-0"
            />
            ...
            <img
              ...
              className="absolute left-0 top-8 lg:-left-10 w-40 h-28 object-cover rounded-xl shadow-2xl border border-border z-20"
            ...
            <img
              ...
              className="absolute right-0 bottom-14 lg:-right-8 w-36 h-24 object-cover rounded-xl shadow-2xl border border-border z-20"
            ...
            <img
              ...
              className="absolute right-0 top-4 lg:-right-6 w-32 h-20 object-cover rounded-xl shadow-2xl border border-border z-20"
